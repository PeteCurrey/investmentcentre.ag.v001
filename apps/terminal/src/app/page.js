    ...
    return (<div style={{
      ...
      <footer style={{
        ...
        <div style={{ display: 'flex', gap: '20px' }}>
          <link_1.default href="/brief" style={{ color: '#94A3B8', textDecoration: 'none' }}>THE BRIEF</link_1.default>
          <link_1.default href="/trade" style={{ color: '#C8F135', textDecoration: 'none', fontWeight: 600 }}>TRADE DESK</link_1.default>
