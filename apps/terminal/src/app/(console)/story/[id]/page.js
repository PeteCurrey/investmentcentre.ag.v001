...
const stories_1 = require("../../../../lib/stories");
...
function StoryPage() {
    ...
    const id = params?.id;
    const story = (0, stories_1.getStory)(id);
    if (!story)
        return (0, navigation_1.notFound)();
    const related = (0, stories_1.getRelatedStories)(id);
    ...
    return (<div style={{ display: 'flex', flexDirection: 'column', gap: '24px', maxWidth: '900px' }}>

      {/* Breadcrumb */}
      <div style={{ display: 'flex', alignItems: 'center', gap: '8px', fontSize: '11px', fontFamily: '"DM Mono", monospace', color: '#6B7280' }}>
        <link_1.default href="/" style={{ color: '#1C3A5E', textDecoration: 'none', fontWeight: 700 }}>THE BRIEF</link_1.default>
        <span>/</span>
      ...
      <div style={{ borderBottom: '2px solid #1C3A5E', paddingBottom: '20px' }}>
        <div style={{ display: 'flex', alignItems: 'center', gap: '10px', marginBottom: '8px', flexWrap: 'wrap' }}>
          ...
          {story.salienceScore && (<span style={{
                padding: '2px 8px',
        ...
        {story.metricLabel && (<div style={{ marginTop: '12px', display: 'flex', alignItems: 'center', gap: '12px' }}>
      ...
      <div style={{
        ...
        <div style={{ flex: 1, maxWidth: '280px', display: 'flex', alignItems: 'center', gap: '3px' }}>
          {[12, 18, 28, 14, 22, 32, 16, 24, 30, 20, 14, 26, 32, 18, 12, 24, 28, 16, 20, 14].map((h, idx) => (<div key={idx} style={{
                flex: 1,
                height: `${h}px`,
      ...
      <div style={{
        ...
        <div style={{ marginTop: '12px', display: 'flex', flexWrap: 'wrap', gap: '6px' }}>
          {story.traderImpact.affectedTraderTypes.map(t => (<span key={t} style={{
                padding: '2px 8px',
      ...
      <div style={{ border: '1px solid #E4E4DF' }}>
        ...
        <div style={{ display: 'flex', flexDirection: 'column' }}>
          {story.instruments.map((inst, idx) => {
            ...
            return (<div key={inst.ticker} style={{
                    padding: '14px 16px',
      ...
      <div style={{ border: '1px solid #E4E4DF' }}>
        ...
        <ul style={{ padding: '16px 20px 16px 36px', margin: 0, display: 'flex', flexDirection: 'column', gap: '8px' }}>
          {story.keyFacts.map((fact, idx) => (<li key={idx} style={{
                fontFamily: '"DM Mono", monospace',
                fontSize: '12px',
                color: '#14181B',
                lineHeight: 1.5,
      ...
      <div style={{ display: 'flex', flexWrap: 'wrap', gap: '6px' }}>
        {story.tags.map(tag => (<span key={tag} style={{
                padding: '2px 8px',
                backgroundColor: '#F7F7F5',
                border: '1px solid #E4E4DF',
                fontFamily: '"DM Mono", monospace',
      ...
      {/* Related Stories */}
      {related.length > 0 && (<div style={{ border: '1px solid #E4E4DF' }}>
          <div style={{
                backgroundColor: '#F7F7F5',
                padding: '12px 16px',
                fontSize: '11px',
          ...
          <div style={{ display: 'flex', flexDirection: 'column' }}>
            {related.map((rel, idx) => {
                ...
                return (<link_1.default key={rel.id} href={`/story/${rel.id}`} style={{
                        padding: '14px 16px',
