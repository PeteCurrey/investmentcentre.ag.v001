    ...
    return (<div style={{ display: 'flex', flexDirection: 'column', gap: '20px' }}>
      ...
      <div style={{
        ...
        <div>
          ...
          {tier4Enabled ? (<span style={{ color: '#166534', fontWeight: 700, backgroundColor: '#FFFFFF', padding: '2px 8px', border: '1px solid #86EFAC' }}>⚡ LIVE — EXECUTE MODE</span>) : (<span style={{ color: '#991B1B', fontWeight: 700 }}>CONFIG-DISABLED — OBSERVE MODE</span>)}
        </div>
        {tier4Enabled && (<div style={{ textAlign: 'right', fontSize: '11px', color: '#166534' }}>
      ...
      <div style={{ border: '1px solid #E4E4DF' }}>
        ...
        <table style={{ width: '100%', borderCollapse: 'collapse', fontSize: '12px', fontFamily: '"DM Mono", monospace' }}>
          ...
          <tbody>
            {rules.map((r) => (<tr key={r.id} style={{ borderBottom: '1px solid #E4E4DF' }}>
