    ...
    return (<div style={{ display: 'flex', flexDirection: 'column', gap: '20px' }}>
      <div style={{ borderBottom: '1px solid #E4E4DF', paddingBottom: '16px' }}>
        ...
        <p style={{ fontSize: '13px', color: '#6B7280', marginTop: '4px' }}>
          Every standing position MUST possess explicit, measurable falsification criteria. Unfalsifiable positions are prohibited. Click a thesis for deeper analysis.
        </p>
      </div>

      <div style={{ display: 'flex', flexDirection: 'column', gap: '16px' }}>
        {theses.map((t) => (<link_1.default key={t.id} href={`/story/${t.id}`} style={{ textDecoration: 'none', display: 'block' }}>
            <div style={{
              ...
              <div style={{ borderTop: '1px solid #E4E4DF', paddingTop: '12px' }}>
                ...
                <ul style={{ listStyle: 'none', padding: 0, margin: 0, display: 'flex', flexDirection: 'column', gap: '6px' }}>
                  {t.criteria.map((c, idx) => (<li key={idx} style={{
                    padding: '8px 12px',
                    backgroundColor: '#FFFFFF',
                    border: '1px solid #E4E4DF',
                    fontSize: '12px',
