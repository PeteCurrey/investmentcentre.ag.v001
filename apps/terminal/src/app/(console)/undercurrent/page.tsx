  ...
  return (
    <div style={{ display: 'flex', flexDirection: 'column', gap: '20px' }}>
      ...
      <div style={{ display: 'flex', flexDirection: 'column', gap: '16px' }}>
        {entityJoins.map((join, idx) => (
          <div key={idx} style={{ border: '1px solid #E4E4DF', padding: '20px', backgroundColor: '#FFFFFF' }}>
            <div style={{ borderBottom: '1px solid #E4E4DF', paddingBottom: '12px', marginBottom: '16px' }}>
            ...
            <div style={{ display: 'grid', gridTemplateColumns: 'repeat(3, 1fr)', gap: '16px' }}>
              {/* Congressional Trade */}
              <div style={{ border: '1px solid #E4E4DF', padding: '14px', backgroundColor: '#F7F7F5' }}>
              ...
              <div style={{ border: '1px solid #E4E4DF', padding: '14px', backgroundColor: '#F7F7F5' }}>
                ...
                <div style={{ fontSize: '14px', color: '#1C3A5E', fontWeight: 700, margin: '4px 0' }}>
                  <Value provenance={{ value: join.govContract.amount, source: 'usaspending', sourceTimestamp: join.govContract.awardedAt, stalenessSeconds: 86400 }} />
                </div>
                <div style={{ fontSize: '11px', color: '#6B7280', fontFamily: '"DM Mono", monospace' }}>
