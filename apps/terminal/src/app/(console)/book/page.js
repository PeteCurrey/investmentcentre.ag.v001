    ...
    return (<div style={{ display: 'flex', flexDirection: 'column', gap: '20px' }}>
      ...
      <div style={{ border: '1px solid #E4E4DF' }}>
        ...
        <table style={{ width: '100%', borderCollapse: 'collapse', fontSize: '12px', fontFamily: '"DM Mono", monospace' }}>
          ...
          <tbody>
            {positions.map((pos, i) => (<tr key={i} style={{ borderBottom: '1px solid #E4E4DF' }}>
                ...
                <td style={{ padding: '12px 16px' }}>
                  <Value_1.Value provenance={{ value: pos.currentPrice, source: 'twelve_data', sourceTimestamp: new Date().toISOString(), stalenessSeconds: 5 }}/>
                </td>
