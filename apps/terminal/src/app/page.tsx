    ...
    <div style={{
      ...
      <footer style={{
        ...
        <div style={{ display: 'flex', gap: '20px' }}>
          <Link href="/brief" style={{ color: '#94A3B8', textDecoration: 'none' }}>THE BRIEF</Link>
          <Link href="/trade" style={{ color: '#C8F135', textDecoration: 'none', fontWeight: 600 }}>TRADE DESK</Link>
