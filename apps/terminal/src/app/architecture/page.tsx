    ...
    <div style={{
      ...
      <header style={{
        ...
        <div style={{ display: 'flex', alignItems: 'center', gap: '24px' }}>
          <Link href="/landing" style={{ fontSize: '14px', fontWeight: 600, letterSpacing: '2px', color: '#F8FAFC', textDecoration: 'none' }}>
            MERIDIAN // TERMINAL
          </Link>
        ...
        <div style={{ border: '1px solid #1E293B', backgroundColor: '#0F172A', padding: '28px' }}>
          ...
          <div style={{ display: 'grid', gridTemplateColumns: 'repeat(3, 1fr)', gap: '12px' }}>
            {[
              ...
              <div key={i} style={{ border: '1px solid #1E293B', backgroundColor: '#0A0D12', padding: '16px' }}>
      ...
      <footer style={{
        ...
        <div style={{ display: 'flex', gap: '20px' }}>
          <Link href="/landing" style={{ color: '#94A3B8', textDecoration: 'none' }}>OVERVIEW</Link>
          <Link href="/" style={{ color: '#94A3B8', textDecoration: 'none' }}>CONSOLE</Link>
        </div>
      </footer>
    </div>
  );
